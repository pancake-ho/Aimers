...
2) Re-quantize merged model with AutoRound hybrid bits
   - gate_proj/up_proj/down_proj: 8-bit
   - all other layers: 4-bit
...
def parse_args():
    p = argparse.ArgumentParser(description="Merge adapter + hybrid AutoRound export + zip")
